...
| DM-PED-032 | Salir con cambios sin guardar → modal con opciones | Ítems en carrito y cambios (botones habilitados). **Aplicación: Siempre** | 1. Pulsar atrás en cabecera del formulario. | N/A | Modal con "Salir y guardar", "Salir sin guardar" y "Cancelar". | FAIL: Sale sin modal. | S2 | `pedido.component.ts:510-517` |
