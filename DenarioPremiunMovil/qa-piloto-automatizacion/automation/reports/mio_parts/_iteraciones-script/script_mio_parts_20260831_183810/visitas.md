...
- ✅ **DM-VIS-004** RUTA DE HOY → lista + searchbar _(searchbar: true · ítems: 0 (puede ser 0 = OK))_
...
- ✅ **DM-VIS-DATA-001** Cliente de prueba con sucursal utilizable _("MIO PARTS & SERVICES, C.A." habilitó el formulario al primer intento)_
- ✅ **DM-VIS-010** Seleccionar cliente → tabs habilitadas _("MIO PARTS & SERVICES, C.A.Código: J409074560 Saldo BS: 3.858" · ACTIVIDADES: true · ADJUNTOS: true · sucursal: false)_
- ✅ **DM-VIS-014** AÑADIR ACTIVIDAD/EVENTO → modal _(select: true · input: true · btns: [CANCELAR, Agregar])_
- ✅ **DM-VIS-015** Agregar actividad → evento con su comentario _(comentario "Test-VIS-015-5915" LEÍDO en la fila del evento · eventos: 1)_
...
- ✅ **DM-VIS-020** Click Enviar → Enviado _(alerts: [Aceptar,OK,OK] · home: true · BD-OK(id=2733,st=2,visited=true) · BD-FIELD-OK)_
- ✅ **DM-VIS-021** Back con cambios → modal 3 opciones _(opciones: [Guardar y salir, Salir sin guardar, Cancelar])_
- ✅ **DM-VIS-022** "Salir sin guardar" → visita no guardada _(salida: "Salir sin guardar" · ítems antes: 1 · después: 1)_
