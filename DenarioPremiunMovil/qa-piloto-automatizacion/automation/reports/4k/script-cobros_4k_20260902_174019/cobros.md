...
- ❌ **DM-COB-004** Seleccionar cliente → tabs habilitadas _(cliente: "C.0507" · tabs habilitadas: 1)_
...
- ❌ **DM-COB-020** Atrás con cambios → modal _(No se pudo llegar a home cobros)_
- ❌ **DM-COB-021** Salir sin guardar _(No se pudo llegar a home cobros)_
...
**Resumen:** N/A:14 · PASS:4 · FAIL:5 · BLOCKED:13
_Tiempo: 101.6s_