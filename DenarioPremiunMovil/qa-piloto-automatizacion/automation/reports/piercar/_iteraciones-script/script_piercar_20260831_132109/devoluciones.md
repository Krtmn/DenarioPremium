...
- ✅ **DM-DEV-019** Guardar + BUSCAR → aparece Guardado en lista _(ítems: 3 · Guardado: 3)_
- ✅ **DM-DEV-022** Abrir Guardado → form editable con tabs accesibles _(tabs accesibles: 3)_
- ❌ **DM-DEV-018** Enviar devolución → modal confirmación _(No se pudo llegar a home devoluciones tras 10 intentos [vías: img.fechaAtras (izquierda) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f)] — quedó en {"pagina":"APP-HOME","texto":"Visitas Inventarios Pedidos Devoluciones Cobros Depósitos Vendedores Productos C","modales":0,"alertas":0})_
...
- ❌ **DM-DEV-024** Eliminar Guardado → modal + desaparece _(No se pudo llegar a home devoluciones tras 10 intentos [vías: sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f)] — quedó en {"pagina":"APP-HOME","texto":"Visitas Inventarios Pedidos Devoluciones Cobros Depósitos Vendedores Productos C","modales":0,"alertas":0})_
- ❌ **DM-DEV-025** Atrás desde lista → home módulo _(Ningún control de "atrás" visible (img.fechaAtras / ion-back-button / slot start))_
- ❌ **DM-DEV-020** Atrás sin guardar → modal Salir/Guardar → home _(No se pudo llegar a home devoluciones tras 10 intentos [vías: sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f) → sin control de atrás (Ningún control de "atrás" visible (img.f)] — quedó en {"pagina":"APP-HOME","texto":"Visitas Inventarios Pedidos Devoluciones Cobros Depósitos Vendedores Productos C","modales":0,"alertas":0})_
