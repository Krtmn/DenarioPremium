...
- ❌ **DM-DEV-015** Tab Adjuntos → acordeones visibles _(imágenes: false · archivo: false · firma: false · acordeones visibles: 1)_
- ✅ **DM-DEV-016** Guardar devolución → mensaje confirmación _(alert: "¡Su Devolución se ha guardado!")_
- ✅ **DM-DEV-019** Guardar + BUSCAR → aparece Guardado en lista _(ítems: 4 · Guardado: 4)_
- ✅ **DM-DEV-022** Abrir Guardado → form editable con tabs accesibles _(tabs accesibles: 3)_
- ❌ **DM-DEV-018** Enviar devolución → modal confirmación _(Tab "Producto" no utilizable tras 6s — pestañas presentes: [General · Productos (disabled) · Adjuntos (disabled)])_
- ✅ **DM-DEV-021** BUSCAR → lista con searchbar _(searchbar: true · ítems: 4)_
- ⬜ **DM-DEV-023** Abrir Enviado → solo lectura _(sin devoluciones Enviado/Por Enviar que abrir — 4 ítem(s) en lista, estados presentes: Guardado. Requiere que DEV-018 (Enviar) complete antes.)_
