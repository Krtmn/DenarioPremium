...
- ✅ **DM-DEV-014** Ingresar cantidad → queda en el campo _(cantidad LEÍDA del campo: "3" · unidad: false · motivo: true)_
...
- ✅ **DM-DEV-019** Guardar + BUSCAR → aparece Guardado en lista _(ítems: 5 · Guardado: 4)_
- ✅ **DM-DEV-022** Abrir Guardado → form editable con tabs accesibles _(tabs accesibles: 3)_
- ❌ **DM-DEV-018** Enviar devolución → modal confirmación _(No se pudo pulsar Enviar tras 8s — {"motivo":"el botón está DESHABILITADO","segmento":"productos","productosEnCarrito":1,"cantidadEnCampo":"3","guardarDisponible":true})_
