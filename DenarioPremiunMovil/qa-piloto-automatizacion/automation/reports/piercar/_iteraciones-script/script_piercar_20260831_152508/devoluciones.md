...
- ✅ **DM-DEV-019** Guardar + BUSCAR → aparece Guardado en lista _(ítems: 7 · Guardado: 4)_
...
- ❌ **DM-DEV-VAL-001** Cantidad mayor a la facturada → la app bloquea el envío _(Form no abrió)_
- ✅ **DM-DEV-021** BUSCAR → lista con searchbar _(searchbar: true · ítems: 8)_
