...
| DM-PRD-019 | Botón "Volver" en lista de productos → regresa a la pantalla de estructuras | Lista de productos abierta (llegada desde estructura o desde búsqueda global). **Aplicación: Siempre** | 1. Desde la lista de productos, pulsar el botón con ícono de flecha izquierda (Volver) visible en la barra de búsqueda. 2. Observar la pantalla. | N/A | App regresa a la pantalla de estructuras con los selectores de empresa y tipo de estructura. El campo de búsqueda queda vacío. | FAIL: Botón "Volver" no aparece en la barra de búsqueda dentro de la lista; al pulsarlo navega a Home u otra pantalla inesperada; app colapsa. | S2 | `src/app/productos/productos-search/productos-search.component.ts:57-59` (`onReturnStructures`), `src/app/productos/productos.component.ts:100-107` (`viewStructures`) |
...
9. **DM-PRD-019** — Botón "Volver" → regresa a estructuras
10. **DM-PRD-020** — Cabecera atrás desde detalle → lista de productos
11. **DM-PRD-021** — Cabecera atrás desde estructuras → Home
