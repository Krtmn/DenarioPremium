...
| **F1 · Infra web** | `WEB-RUNTIME.md` · `playas.yaml` · `web-helpers.js` (login, navegación, búsqueda por Nro.Ref, lectura de detalle a JSON) + self-test · resolución playa→URL desde los payloads de la corrida | **1–1.5** | F0 |
