...
export class Orders {
    ...
    static ordersJson(obj: Orders) {
        return new Orders(
            ...
            obj['nuAmountTax'],
            obj['nuAmountTaxConversion'],
            obj['idOrderType'],
            obj['orderDetails'],
            obj['nuDetails'],
            obj['nuAmountTotalProductDiscount'],
            obj['nuAmountTotalProductDiscountConversion'],
            obj['nuAmountGlobalDiscount'] ?? 0,
            obj['nuAmountGlobalDiscountConversion'] ?? 0,
            obj['hasAttachments'],
            obj['nuAttachments'],
    ...
    constructor(
        ...
        public nuAmountTaxConversion: number,
        ...
        public nuAmountGlobalDiscount: number,
        public nuAmountGlobalDiscountConversion: number,
