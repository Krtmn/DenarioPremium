...
- ❌ **DM-COB-004** Seleccionar cliente → tabs habilitadas _(pedido: "C.0060" · clickeado: "motor s diesel, c.a. código: c.0060 saldo bs: 3.103.116,00 saldo usd: 3.566,80 m" · tabs habilitadas: 1 · 🔴 EL COMENTARIO NO SE ESCRIBIÓ (es lo que bloquea las pestañas))_
...
- ✅ **DM-COB-REQ-002** REQ · Rechaza el envío con obligatorios vacíos y dice qué falta _(C1 ok (deshabilitado) · C2 ok — 1 marca(s): borde rojo)_
...
- ⬜ **DM-COB-026** Eliminar Guardado _(Guardados: 0 · botón trash: false)_
...
**Resumen:** N/A:8 · PASS:14 · FAIL:1 · BLOCKED:13
_Tiempo: 62.3s_