...
- ❌ **DM-COB-051** Tasa escrita: 85% se acepta · 86% se rechaza _(85% → alerta: "Denario Cobros · Se superó el límite de descuento (85%). Máximo disponible: 5%.", marcado: false · 86% → alerta: "NINGUNA", marcado: false (debe quedar false: al exceder se QUITA))_
...
- 🚫 **DM-COB-024** Reabrir Guardado → los datos persisten _(no hay nada que cotejar: la foto previa quedó vacía (0 campos leídos, 0 con valor). El cobro se reabrió (tabs: 5), pero eso NO prueba persistencia · diagnóstico: 0 input(s) visibles, pestaña "?" · ninguno con rótulo)_
...
**Resumen:** N/A:5 · PASS:19 · FAIL:4 · BLOCKED:13
_Tiempo: 112.5s_