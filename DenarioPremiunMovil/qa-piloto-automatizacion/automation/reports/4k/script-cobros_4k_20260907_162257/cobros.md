...
- ✅ **DM-COB-007** Tab Documentos → lista + leyenda _(documentos: 2 · leyenda: true)_
- ✅ **DM-COB-008** Marcar documento → total en Pagos _(marcados: 2 · total: "Monto total a pagar Bs: 1.017.900,00 Diferencia Bs: -1.017.9")_
...
- ✅ **DM-COB-040** Completar pago Efectivo = total → diferencia azul _(monto: 101790000 · antes: -1.017.900,00(red) · después: 0,00(blue))_
- ✅ **DM-COB-012** Diferencia rojo (insuf.) → azul (cubre) _(antes: red · después: blue)_
- ✅ **DM-COB-043** Diferencia se actualiza con el monto _(antes: -1.017.900,00 · después: 0,00)_
...
- ✅ **DM-COB-019** Enviar cobro → llega a la nube _(clic:mouse · diálogo: "Denario Cobros · El Cobro será enviado" · ☁ EN LA NUBE: 1788812581641.0 · 1017900.0000 Bs · st=3 (comentario Test-COB-577990) · ⚠ la UI no lo reflejaba (UI → guardados: 0 · enviados: 0 · total en lista: 0) — revisar solo si se repite · cotejo del payload enviado: BD-FIELD-OK)_
...
**Resumen:** N/A:5 · PASS:22 · FAIL:2 · BLOCKED:12
_Tiempo: 121.3s_