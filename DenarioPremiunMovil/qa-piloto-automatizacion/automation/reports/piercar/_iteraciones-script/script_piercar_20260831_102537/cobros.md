...
- ✅ **DM-COB-001** Módulo Cobros → home (COBRO + BUSCAR) _(botones: COBRO, ANTICIPO/PREPAGO, RETENCIÓN, IGTF, BUSCAR)_
- ✅ **DM-COB-002** COBRO → form 5 tabs; resto disabled sin cliente _(tabs: 5 (General/Documentos/Pagos/Total/Adjuntos) · habilitadas: 1)_
- ✅ **DM-COB-004** Seleccionar cliente → tabs habilitadas _(cliente: "7 CARS" · tabs habilitadas: 5)_
- ✅ **DM-COB-007** Tab Documentos → lista + leyenda _(documentos: 1 · leyenda: true)_
- ✅ **DM-COB-008** Marcar documento → total en Pagos _(marcados: 1 · total: "Monto total a pagar BS: 1.068.865,33 Diferencia BS: -1.068.8")_
- ✅ **DM-COB-009** Tab Pagos → modal métodos de pago _(métodos: Efectivo, Depósito, Transferencia, Pago Móvil)_
- ✅ **DM-COB-040** Completar pago Efectivo = total → diferencia azul _(monto: 106886533 · antes: -1.068.865,33(red) · después: 0,00(blue))_
- ✅ **DM-COB-012** Diferencia rojo (insuf.) → azul (cubre) _(antes: red · después: blue)_
- ✅ **DM-COB-043** Diferencia se actualiza con el monto _(antes: -1.068.865,33 · después: 0,00)_
...
- ⏭️ **DM-COB-019** Enviar cobro _(requiredCollectionAttachments=true + mock_camara_funciona=false → Guardado, envío manual QA)_
- ✅ **DM-COB-022** BUSCAR → lista con searchbar _(lista: true · ítems: 10 · searchbar: true)_
...
**Resumen:** N/A:2 · PASS:16 · SKIP:1 · BLOCKED:12
_Tiempo: 67.8s_